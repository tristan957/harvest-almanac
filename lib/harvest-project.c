...
struct _HarvestProject
{
	...
	char *code;
	gboolean is_active;
	gboolean is_billable;
	gboolean is_fixed_fee;
	char *bill_by;
	double hourly_rate;
	double budget;
	char *budget_by;
	gboolean budget_is_monthly;
	gboolean notify_when_over_budget;
	double over_budget_notification_percentage;
	GDateTime *over_budget_notification_date;
	gboolean show_budget_to_all;
	double cost_budget;
	gboolean cost_budget_include_expenses;
	double fee;
	char *notes;
	GDateTime *starts_on;
	GDateTime *ends_on;
