...
static void
harvest_client_init(HarvestClient *self)
{
...
harvest_client_new()
{
	return g_object_new(HARVEST_TYPE_CLIENT, "server", HARVEST_API_URL_V2, NULL);
}
...
size_t
harvest_client_write_cb(char *content, size_t size, size_t nmemb, void *user_data)
{
