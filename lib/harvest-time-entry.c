...
harvest_time_entry_class_init(HarvestTimeEntryClass *klass)
{
	...
	obj_properties[PROP_SPENT_DATE]		 = g_param_spec_boxed("spent_date", _("Spent Date"),
		 _("Date of the time entry."), G_TYPE_DATE_TIME, G_PARAM_CONSTRUCT | G_PARAM_READWRITE);
	...
	obj_properties[PROP_USER_ASSIGNMENT] = g_param_spec_object("user_assignment",
		...
		HARVEST_TYPE_USER_ASSIGNMENT, G_PARAM_CONSTRUCT | G_PARAM_READWRITE);
	...
	obj_properties[PROP_TASK_ASSIGNMEMT] = g_param_spec_object("task_assignment",
		...
		HARVEST_TYPE_TASK_ASSIGNMENT, G_PARAM_CONSTRUCT | G_PARAM_READWRITE);
	...
	obj_properties[PROP_NOTES]			 = g_param_spec_string("notes", _("Notes"),
		  _("Notes attached to the time entry."), NULL, G_PARAM_CONSTRUCT | G_PARAM_READWRITE);
	...
	obj_properties[PROP_LOCKED_REASON]   = g_param_spec_string("locked_reason", _("Locked Reason"),
		  _("Why the time entry has been locked."), NULL, G_PARAM_CONSTRUCT | G_PARAM_READWRITE);
